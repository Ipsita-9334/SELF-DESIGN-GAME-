...
var cloudsGroup, darkCloudsGroup, shipsGroup, purpleBirdsGroup, BlueBirdsGroup;
var helicopter;
var score = 0;
...
function setup() {
  ...
  sea = createSprite(width/2, height + 50, windowWidth, 300);
...
function spawnShip1(){
  if(frameCount % 500 === 0){
    var ship = createSprite(width-100, height-250, 10,10);
    ship.velocityX = -2;
    
   ship.addImage(ship1Img);
    ship.scale = 1;
    ship.lifetime = displayWidth;
